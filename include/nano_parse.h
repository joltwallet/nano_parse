...
uint32_t nanoparse_rest_block_count();
...
nl_err_t nanoparse_rest_work(const hex256_t hash, uint64_t *work);
nl_err_t nanoparse_rest_account_frontier(const char *account_address, hex256_t frontier_block_hash);
nl_err_t nanoparse_rest_block(const hex256_t block_hash, nl_block_t *block);
nl_err_t nanoparse_rest_pending_hash( const char *account_address,
        hex256_t pending_block_hash, mbedtls_mpi *amount);
nl_err_t nanoparse_rest_frontier_block(nl_block_t *block);
nl_err_t nanoparse_rest_process(nl_block_t *block);
